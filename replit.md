...
- **System Design**: Focuses on authentic intelligence assessment using a 4-Phase Intelligence Evaluation System: Phase 1 (Initial Assessment with anti-diplomatic instructions), Phase 2 (Deep analytical questioning using real cognitive evaluation criteria), Phase 3 (Revision and reconciliation of discrepancies), and Phase 4 (Final pushback for scores under 95/100). The system uses legitimate intelligence evaluation methods rather than fabricated cognitive dimensions, supporting genre-aware assessment for various document types (philosophical, empirical, technical, fiction) and comprehensive intelligence reports with percentile rankings based on genuine cognitive abilities.
